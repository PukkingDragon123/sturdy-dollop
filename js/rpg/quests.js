...
KD.Quests = (function () {
  ...
  const Q = [
    { id: 'firstrep', give: 'santa', name: 'One Honest Set',
    ...
    { id: 'firstdig', give: 'santa', name: 'Something With An Edge',
    ...
    { id: 'lighter', give: 'santa', name: 'Eighteen Kilos',
    ...
    { id: 'gatepass', give: 'santa', name: 'Past The Gate',
    ...
    { id: 'reeffish', give: 'santa', name: 'Something For The Pot',
    ...
    { id: 'champ1', give: 'santa', name: 'Old Scar',
    ...
    { id: 'champ2', give: 'santa', name: 'The Tangle',
    ...
    { id: 'champ3', give: 'santa', name: 'The Last Warden',
    ...
    { id: 'champ4', give: 'santa', name: 'The Long Shadow',
    ...
    { id: 'crown', give: 'santa', name: 'The Crown',
